...
const Legal = () => {
  return (
    <div className="legal-container paddingsec ">
      <h1>Terms of Use</h1>
      <p>
      ...
      <h2 className='titlsublegl'>NO OFFER, SOLICITATION, OR ADVICE</h2>
      <p>
      ...
      <h2 className='titlsublegl'>LIMITATION OF LIABILITY</h2>
      <p>
        Except as specifically agreed by a Interllekt entity in writing, NO INTERLLEKT INDIVIDUAL OR ENTITY SHALL HAVE ANY LIABILITY BASED UPON YOUR USE OF, OR RELIANCE UPON, THIS WEBSITE OR THE MATERIALS. Some jurisdictions limit our ability to disclaim liability. With regard to those jurisdictions, our liability shall be limited to the greatest extent permitted by applicable law.
      </p>
      <h2 className='titlsublegl'>MODIFICATION OF THESE TERMS</h2>
      <p>
