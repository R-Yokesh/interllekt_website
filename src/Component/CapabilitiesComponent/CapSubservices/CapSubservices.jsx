...
const CapSubservices = () => {
  const services = [
    { name: 'Social Media Imaging', logo: require('../../../Assets/Images/Color Mark 4.png') },
    { name: 'Creative Ideation', logo: require('../../../Assets/Images/Color Mark 3.png') },
...
//     { name: 'Digital Environment', logo: require('../../../Assets/Images/Color Mark 1.png') },
//     { name: 'Aesthetics', logo: require('../../../Assets/Images/Color Mark 3.png') },
//     { name: 'Web app development', logo: require('../../../Assets/Images/Color Mark 2.png') },
